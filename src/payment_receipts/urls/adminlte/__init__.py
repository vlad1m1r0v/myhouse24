...
urlpatterns = [
    path('receipts/', include([
        ...
        path('templates/', include('src.payment_receipts.urls.adminlte.templates')),
        path('<int:pk>/', views.AdminReceiptDetailView.as_view(), name='detail'),
        ...
        path('datatable/', views.AdminReceiptsDatatableView.as_view(), name='datatable'),
        ...
        path('api/flat-info-by-account/', views.AdminReceiptsFlatInfoByAccountView.as_view(),
             name='flat-info-by-account'),
