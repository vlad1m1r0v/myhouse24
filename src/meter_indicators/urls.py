...
urlpatterns = [
    ...
    path('adminlte/meter-indicators/',
         views.AdminListMeterIndicatorsView.as_view(),
         name='adminlte_meter_indicators_list'),
    path('adminlte/meter-indicators/datatable/',
         views.AdminMeterIndicatorsDatatableView.as_view(),
         name='adminlte_meter_indicators_datatable'),
    ...
    path('adminlte/meter-indicators/for-flat/datatable/',
         views.AdminMeterIndicatorsForFlatDatatableView.as_view(),
