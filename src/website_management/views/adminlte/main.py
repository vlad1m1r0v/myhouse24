...
class AdminMainPageView(WebsitePermissionRequiredMixin,
                        TemplateView):
    template_name = 'website_management/adminlte/main.html'
    ...
    def post(self,request, *args, **kwargs):
        ...
        return redirect(reverse_lazy('adminlte:website-management:home'))